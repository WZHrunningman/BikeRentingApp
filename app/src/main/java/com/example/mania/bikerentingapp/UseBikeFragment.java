...
public class UseBikeFragment extends Fragment implements View.OnClickListener {
    ...
    private TextView tv_bikemassage,tv_time,tv_minute,tv_second;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_usebike, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        tv_bikemassage = view.findViewById(R.id.tv_bikemassage);
        ...
        switch (v.getId()){
            ...
            case R.id.btn_startuse:
                if (Utils.isFastClick()){
                    ...
                    if (flag == 0) {
                        BmobQuery<BikeMassage> query = new BmobQuery<BikeMassage>();
                        query.addQueryKeys("bikenumber");
                        query.findObjects(new FindListener<BikeMassage>() {
                            @Override
                            public void done(List<BikeMassage> list, BmobException e) {
                                if (e == null) {
                                    for (BikeMassage bikeMassage : list) {
                                        if (bikeMassage.getBikenumber().equals(number) ){
                                            ...
                                            customDialog.setQueding("确定", new CustomDialog.IquedingListener() {
                                                ...
                                                public void queding(CustomDialog dialog) {
                                                    ...
                                                    tv_bikemassage.setVisibility(View.VISIBLE);
                                                    ll_time.setVisibility(View.VISIBLE);
                                                    tv_bikemassage.setText("单车编号: " + number);
